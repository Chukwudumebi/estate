...
export default function Design() {
    ...
    return (
        ...
        <div className=" relative mx-auto  w-full mt-1 md:mt-1 text-black  md:m-auto md:w-full max-w-3xl grid-flow-dense  grid-cols-2 grid-rows-auto-1fr justify-center gap-2 rounded-xl p-3 px-4 text-center text-white">
                   <div className="Desc ">
