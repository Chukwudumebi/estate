    ...
    return(
        <form className="flex  items-center justify-center mr-3 ">
            <label className="flex">
                ...
                <span className="rounded-r-lg bg-gradient-to-br from-blue-900 to-sky-600 py-2 px-3 border-2 border-gray-100 hover:cursor-pointer hover:bg-blue-400 focus:outline focus:outline-solid focus: outline-blue-400">
