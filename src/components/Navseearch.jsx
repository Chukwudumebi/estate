    ...
    return(
        <form className="flex  items-center justify-center m-2 ">
            <label className="flex">
                <input type="text" placeholder="Search Categories..." className=" focus:outline focus: outline-blue-500 bg-transparent border-2  px-1 rounded-l-lg border-gray-100  text-gray-2 focus:outline-none"/>
