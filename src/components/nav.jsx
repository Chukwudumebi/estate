        ...
        <div className="shadow-md w-full sticky top-0 left-0  z-[20]">
          <div className="border-b bg-white">
            ...
            <div className="md:flex items-center justify-evenly bg-white  md:px-10 px-7">
                 ...
                 <button onClick={handleModalOpen} className={`sm:flex ${open ? "hidden":"block"} font-bold bg-blue-500 text-white md:ml-0 ml-[130px] rounded-lg py-2 px-5 mt-3 md:mt-0 shadow-lg hover:bg-blue-400`}>
                  send
                 </button> 
